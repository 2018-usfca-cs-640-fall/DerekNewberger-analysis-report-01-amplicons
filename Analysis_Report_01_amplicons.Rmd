...
They had a more stringent sequence cut off with dropping
anything less than 200 bp and had an upper limit of 300 bp
while keeping the 25 score equal to what I did. The sequences
were matched using their OTUs with a minimum coverage of 97%
and a minimum identity of 97%. They used the NAST and
Greengenes database with using a minimum alignment of 150 bp
and a minimun identity of 75%. To measure the amount of
dissimilarity between pairs of bacterial communities, they
used the UniFracmetric. The shorter the distance, the greater
the chance of similarities. They used all of these
abbreviated procedures to analyze their data. They claim to
have found that this process can potentially be used as a
forensic metric since the communities matched up well with
the corresponding individuals swabbed.
