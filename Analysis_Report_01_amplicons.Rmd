...
# Plots the quality profiles of the first twenty samples out of 115
...
phyloseq_obj_qu <- subset_samples(phyloseq_obj, sample_source=="Ukey"|sample_source=="Qkey")
plot_bar(phyloseq_obj_qu, x = "sample_source")
```

```{r comparing-abundance-for-s-and-l-keys}
# bar plot of samples from S and L keys and Abundance of sequences
phyloseq_obj_sl <- subset_samples(phyloseq_obj, sample_source=="Skey"|sample_source=="Lkey")
...
phyloseq_obj_gh <- subset_samples(phyloseq_obj, sample_source=="Gkey"|sample_source=="Hkey")
...
phyloseq_obj_eo <- subset_samples(phyloseq_obj, sample_source=="Ekey"|sample_source=="Okey")
